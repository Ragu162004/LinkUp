...
const Sidebar = () => {
  ...
  return (
    <div className="w-full h-full grid grid-cols-[48px,1fr] bg-gray-900">
      <div className="bg-gray-800 w-12 h-full rounded-tr-lg rounded-br-lg py-5 text-gray-400 flex flex-col justify-between">
        <div>
          <NavLink
            className={({ isActive }) =>
              `w-12 h-12 flex justify-center items-center cursor-pointer hover:bg-gray-700 rounded ${
          ...
          {allUser.map((conv, index) => {
            return (
              <NavLink
                ...
                key={conv?._id}
                className="flex items-center gap-2 py-3 px-2 border border-transparent hover:border-primary rounded hover:bg-gray-800 cursor-pointer"
              >
                <div>
                  <Avatar
                ...
                <div>
                  <h3 className="text-ellipsis line-clamp-1 font-semibold text-base text-gray-200">
